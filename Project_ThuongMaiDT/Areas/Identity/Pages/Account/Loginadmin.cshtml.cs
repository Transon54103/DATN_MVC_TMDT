...
namespace Project_ThuongMaiDT.Areas.Identity.Pages.Account
{
    public class LoginadminModel : PageModel
    {
        ...
        public LoginadminModel(SignInManager<IdentityUser> signInManager, ILogger<LoginadminModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Response.Cookies.Delete(".AspNetCore.Session"); // Xóa cookie đăng nhập

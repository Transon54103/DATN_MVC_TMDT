    ...
    public class RecommendationRepository : IRecommendationRepository
    {
        ...
        public List<int> GetRecommendedProducts(int productId)
        {
            ...
            var transactions = _db.OrderDetails
                .Where(od => od.OrderHeaderId != null && od.OrderHeader.OrderStatus == SD.StatusComplete && od.OrderHeader.PaymentStatus == SD.PaymentStatusApproved ) // Đảm bảo không có OrderHeader null
